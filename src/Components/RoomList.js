    ...
    <>
      ...
      <div className="search__top">
        ...
        <div
          ...
          style={{ fontSize: "20px", fontFamily: "-moz-initial",marginLeft:"100px;" }}
        >
          <div>
            <div className="row"  style={{ marginRight:"100px;" }}>
              <div className="col-sm-6" style={{ fontSize: "20px", fontFamily: "-moz-initial",marginLeft:"100px;" }}>
                
                <div className="form-group" style={{ fontSize: "20px", fontFamily: "-moz-initial",marginLeft:"100px;" }}>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
